...
export const formatInstructionsForCopy = (
    carbIngredients: Array<{ name: string; amount: number; unit: string }>,
    electrolyteIngredients: Array<{ name: string; amount: number; unit: string }>,
    glucoseBasedCarbs: Array<{ name: string; amount: number; unit: string }>,
    fructoseBasedCarbs: Array<{ name: string; amount: number; unit: string }>,
    totalCarbs: number,
    isBatchMode: boolean,
    hours: number,
    gelsPerHour: number
    ...
    const formatList = (list: Array<{ name: string; amount: number; unit: string }>): string => {
